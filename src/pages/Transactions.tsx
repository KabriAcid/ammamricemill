...
import { mockTransactions, mockIncomeHeads, mockExpenseHeads, MockTransaction } from '../mock';
...
export const Transactions: React.FC = () => {
  ...
  const [editingTransaction, setEditingTransaction] = useState<MockTransaction | null>(null);
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <p className="text-gray-600">Track all income and expense transactions</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-2xl font-bold text-green-600 mt-2">৳{totalIncome.toLocaleString()}</p>
        </div>
        <div className="bg-white rounded-lg shadow-sm p-6">
      ...
      <DataTable
        ...
        columns={columns}
        title={`${filterType === 'all' ? 'All' : filterType.charAt(0).toUpperCase() + filterType.slice(1)} Transactions`}
        onAdd={handleAdd}
        onEdit={handleEdit}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                {(formData.type === 'income' ? incomeHeads : expenseHeads).map((head) => (
