    ...
    children: [
      {
        ...
        icon: "badge",
        link: "human-resource/designation",
      },
      {
        id: "employee",
        title: "Employee List",
      ...
      },
      {
        ...
        icon: "calendar-days",
        link: "human-resource/attendance",
      },
      {
        id: "monthly-attendance",
        title: "Monthly Attendance",
        icon: "calendar-check",
        link: "human-resource/attendance/monthly",
      },
      { id: "salary", title: "Salary Sheet", icon: "wallet", link: "human-resource/salary" },
    ],
  },
  {
    id: "accounts",
