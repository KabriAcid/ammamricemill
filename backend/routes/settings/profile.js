...
// POST /api/settings/admin-profile - Create new admin (sign up another admin)
router.post("/", authenticateAdmin, async (req, res) => {
  try {
    // Check if current user has permission to create admins
    // This is a placeholder - implement your own role-based authorization
    ...
    `;
    const emailExists = await req.db.query(emailCheckQuery, [email]);
